...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DIR_Pin|MS1_Pin|MS2_Pin|MS3_Pin
                          |KEY_C2_Pin|KEY_C1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIR_Pin KEY_C2_Pin KEY_C1_Pin */
  GPIO_InitStruct.Pin = DIR_Pin|KEY_C2_Pin|KEY_C1_Pin;
